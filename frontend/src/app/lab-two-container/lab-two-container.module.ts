...
import { LabTwoContainerRoutingModule } from './lab-two-container-routing.module';
...
@NgModule({
  ...
  imports: [CommonModule, LabTwoContainerRoutingModule],
})
export class LabTwoContainerModule {}
